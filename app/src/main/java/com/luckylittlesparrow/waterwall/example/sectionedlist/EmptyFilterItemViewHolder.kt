...
class EmptyFilterItemViewHolder constructor(view: View) :
    BaseViewHolder<Item>(view) {

    private val eventItemDescriptionTextView: TextView = view.findViewById(R.id.eventEmptyItemDescriptionTextView)
