...
internal class DiffListUtilByItems(private val sectionMediator: SectionMediator) : DiffUtil.Callback() {
    ...
    override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        ...
        val section = sectionMediator.getSectionByItem(newElement)
